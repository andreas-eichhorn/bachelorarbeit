...
\begin{document}
    ...
    Die in Abbildung TODO dargestellten Regeln definieren die Struktur einer Flow-Instanz.
    Dabei legt Regel TODO fest, dass eine Flow-Instanz aus mehreren Eingabe- und Ausgabeports sowie aus Funktionen höherer Ordnung besteht.
    ...
    Ein Flow kann dabei eine eigene erstelle Funktion sein oder eine vordefinierte Funktion.
    \begin{grammar}
    ...
    Die Regeln des FlowModel sind in Abbildung TODO formal dargestellt.
    Durch die Regel TODO wird bestimmt, dass ein FlowModel aus einer FlowInstance, einer Auflistung alle genutzen Flow-Node und definition der Verbindungen zwischen den Eingabe- und Ausgabeports.
    ...
    Die geplante Erweiterung besteht darin zwei Schleifenblock einzuführen, welcher die Möglichkeit bietet, bestimmte Aktivitäten zu wiederholen.
    Die Interaktion erfolgt über die bereits vorhandene grafische Benutzeroberfläche, wobei der Benutzer die Möglichkeit hat durch auswählen des Schleifenblocks die Abbruchbedingung und die Anzahl der maximalen Iterationen festzulegen.
    Beide Schleifenblöcke sind von der Benutzeroberfläche gleiche und unterscheiden sich nur wie sie die Wiederholungen ausführen.
    Dabei soll der Schleifenblock dem TODO ähneln. Der Schleifenblock hat einen onFalse und einen onTrue Pfad, welcher Pfad genommen wird wird durch die Abburchbedingung bestimmt.
    Beim onFalse Pfad wird entschieden, ob eine Wiederholung stattfindet oder nicht. Diese Entscheidung basiert bei Block A auf der Anzahl der bereits ausgeführten Iterationen und Bewertung der Eingaben. Beim Block B hingegen basiert die Entscheidung nur auf der Anzahl der bereits ausgeführten Iterationen.
    Beim onTrue Pfad wird die Prüfung fortgesetzt und es findet keine Wiederholung statt.
