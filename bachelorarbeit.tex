...
\begin{document}
    ...
    Als Datenfluss-basierte Sprache wird eine Programmiersprache verstanden, bei der die Daten von zwischen Funktionnen weitergeleitet werden. Dabei werden Programme als Graphen dargestellt. \cite{11}
