...
\begin{document}
    ...
    Als Ansatz wird dabei Schleifenentfaltung verwendet.
    Ye et al. beschreiben in ihrer Arbeit TODO
    Huang et al. TODO
    Wie eingangs bereits erwähnt wurden ist, sollen die Wiederholungen explizite Ausgeführt werden und nicht rekursiv oder iterativ.
    Dafür muss also der ALgortithmus der Schleifenentfaltung modifiziert werden. 
    Das Ziel der modifizierung ist es, die Schleifen solange zusammenzufassen bis kein erneuter Schleifendurchlauf notwendig ist.
    Da die maximale Anzahl an Schleifendurchläufen durch den Benutzer vorgegeben ist TODO
    Zur auflösen der Schleife wird zuerst der Schleifenkörper ausgeführt, Anschließend erfolgt die Prüfung der Abbruchbedingung. Sollte die Abbruchbedingung falsch sein, wird der nächste kopierte Code verwendet. 
    Hingegen beim erfüülen der Abbruchbedingung keine Wiederholg stattfindet, sondern die Prüfung fortgesetzt wird
    ...
    Bei dem Algorithmus sollen die Eingaben der Dynmaischen\\
    \\
